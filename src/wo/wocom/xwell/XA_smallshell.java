...
public class XA_smallshell extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// final TextView
		// ss_parameter_tv=(TextView)findViewById(R.id.ss_parameter_tv);
		final EditText ss_parameter_et = (EditText) findViewById(R.id.ss_parameter_et);
		// final TextView
		// ss_workdir_tv=(TextView)findViewById(R.id.ss_workdir_tv);
	...
	public static String terminal_str(String cmd, String parameter,
			String workdir) {
