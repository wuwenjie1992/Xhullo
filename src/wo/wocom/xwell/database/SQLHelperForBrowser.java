 ...
 * @version 1.3.2
 * @more 自定义SQLHelper，用于数据库的操作管理
 */
public class SQLHelperForBrowser extends SQLiteOpenHelper {

	public static final String DB_NAME = "historyDB";
	public static final String TB_NAME = "history_TableName";

	public SQLHelperForBrowser(Context context) {
