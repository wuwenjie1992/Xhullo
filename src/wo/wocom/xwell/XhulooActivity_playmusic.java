 ...
 * @version 1.3.5
 * @more 音乐播放界面，调用服务，启动MusicService, 音乐文件路径输入框
 */

public class XhulooActivity_playmusic extends Activity implements
		OnClickListener {

	private static final String TAG = "PM_Xhuloo";

	private Button Previous_bt, Play_bt, Next_bt, Pause_bt, bindservice_bt,
			unbindservice_bt;
	...
	public void onClick(View v) {
		...
		case R.id.play:
			...
			Intent mIntent02 = new Intent(
					wo.wocom.xwell.MusicService.PLAY_ACTION);
	...
	public void return_toast(String show) {
		...
		Toast.makeText(XhulooActivity_playmusic.this, show, Toast.LENGTH_SHORT)
				.show();
		return;
	}
