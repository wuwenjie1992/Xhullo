...
public class XhulooActivity_PHONE extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ph_textview.setText(NBCinfo_sb.toString() + telephone_info_s
				+ androidId);
	...
	protected void onRestart() {
		...
		Toast.makeText(XhulooActivity_PHONE.this, "PH_onRestart",
	...
	protected void onResume() {
		...
		Toast.makeText(XhulooActivity_PHONE.this, "PH_onResume",
				Toast.LENGTH_SHORT).show();
	}
	...
	protected void onPause() {
		...
		Toast.makeText(XhulooActivity_PHONE.this, "PH_onPause",
				Toast.LENGTH_SHORT).show();
	}
	...
	protected void onStop() {
		super.onStop();
		Log.i(TAG, "PH_onStop");
		Toast.makeText(XhulooActivity_PHONE.this, "PH_onStop",
				Toast.LENGTH_SHORT).show();
	}
