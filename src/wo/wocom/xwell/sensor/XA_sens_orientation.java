 ...
 * @version 1.3.5 (XhulooActivity_compass)
 * @see 方向传感,指南针,图片旋转
 */
public class XA_sens_orientation extends Activity implements
		SensorEventListener {

	private static final String TAG = "XA_sens_orientation 方向";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Log.i(TAG, "sens_orientation_onCreate");
	...
	public void onRestart() {
		super.onRestart();
		Log.i(TAG, "sens_orientation_onRestart");
	}

	public void onResume() {
		super.onResume();
		Log.i(TAG, "sens_orientation_onResume");
		// 注册监听器
	...
	public void onPause() {
		super.onPause();
		Log.i(TAG, "sens_orientation_onPause");
		sensorManager.unregisterListener(this);// 注销监听器
	}

	public void onStop() {
		super.onStop();
		Log.i(TAG, "sens_orientation_onStop");
		sensorManager.unregisterListener(this);
	}

	public void onDestroy() {
		super.onDestroy();
		Log.i(TAG, "sens_orientation_onDestroy");
		sensorManager.unregisterListener(this);
	}
